...
export default function Login(props) {
  ...
  return (
    <div>
      <h2 className="mb-8 text-3xl text-customOuterSpace dark:text-white">
        {props.head}
      </h2>
      ...
      <p>{errorMessage}</p>
      <button
        className="bg-customBlue p-5 pl-3 pr-3 rounded-md text-xl w-full justify-items-end text-customFrenchGray font-Roboto disabled:bg-customPlatinum dark:disabled:bg-gray-700 disabled:cursor-not-allowed mb-5"
        onClick={login}
